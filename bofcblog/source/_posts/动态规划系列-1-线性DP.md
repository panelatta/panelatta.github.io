...
> 
>     ![](http://bofc.tech/usr/uploads/2018/06/2035782483.jpg)
> 
...
3.  我们怎样从问题的解空间中获取一个最优解？
    ...
    <table><thead><tr><th align="center">问题</th><th align="center">数塔</th></tr></thead><tbody><tr><td align="center">状态表示</td><td align="center">$ f(i,j) $ 表示从数塔顶部走到第$ i $行第$ j $列，所经过路径的最大和</td></tr><tr><td align="center">阶段划分</td><td align="center">某条路径的结尾位置$(i,j)$</td></tr><tr><td align="center">转移方程</td><td align="center">$ f(i,j) = A(i,j)+max[f(i-1, j-1), f(i-1, j)] $</td></tr><tr><td align="center">边界</td><td align="center">$ f(1,1)=A(1,1) $</td></tr><tr><td align="center">目标</td><td align="center">$ \underset{1 \leq i \leq n}{max}[f(n,i)] $</td></tr></tbody></table>
    ...
    <table><thead><tr><th align="center">问题描述</th><th align="center">LCS问题</th></tr></thead><tbody><tr><td align="center">状态表示</td><td align="center">$f(i, j)$ 表示A的前缀子串 $[1..i]$ 和B的前缀子串 $[1..j]$ 的LCS长度</td></tr><tr><td align="center">阶段划分</td><td align="center">已经处理的前缀在两个字符串中的位置（一个二维坐标）</td></tr><tr><td align="center">转移方程</td><td align="center">$ \begin{cases} &amp; f(i,j)=f(i-1,j-1)+1,X[i]=Z[j]\\ &amp; f(i,j)=max[f(i-1,j),f(i,j-1)],X[i] \neq Z[j] \end{cases} $</td></tr><tr><td align="center">边界</td><td align="center">$ f(i,0)=f(0,j)=0,1 \leq i \leq n, 1 \leq j \leq m $</td></tr><tr><td align="center">目标</td><td align="center">$f(n,m)$</td></tr></tbody></table>
    ...
    ![](http://bofc.tech/usr/uploads/2018/06/2685566188.jpg)
