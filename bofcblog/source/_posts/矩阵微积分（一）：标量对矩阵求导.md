...
定义 $\rm Softmax$ 函数 ${\cal S} : {\frak R}^m \rightarrow {\frak R}$ 且 ${\cal S} ({\bf x})=\dfrac{{\rm exp}({\bf x})}{{\bf 1}^\top {\rm exp}({\bf x})}$ ，其中 ${\bf 1}$ 指全 $1$ 向量。

设 ${\bf y} \in {\frak R}^m$ 除一个元素为 $1$ ，其他元素均为 $0$ ；${\bf x} \in {\frak R}^n$ ，${\bf W} \in {\frak R}^{m \times n}$ ，$l \in {\frak R}$。已知 $l=-{\bf y}^\top \ln{\cal S}({\bf Wx})$ ，求 $\dfrac{\partial l}{\partial \bf W}$ 。
...
&amp;= -{\rm tr}({\bf y}^\top({\rm d}{\bf W}){\bf x}) + {\rm tr}\left({\cal S}({\bf Wx})^\top({\rm d}{\bf W}){\bf x}\right) \\
&amp;= {\rm tr}({\bf x}({\cal S}({\bf Wx})^\top-{\bf y^\top}){\rm d}{\bf W}) \\
&amp;= {\rm tr}\left( \left( {\cal S}\left({\bf Wx}-{\bf y}\right) {\bf x}^\top \right)^\top {\rm d}{\bf W} \right)
\end{aligned}
\end{equation}
$$
...
$$
\frac{\partial l}{\partial \bf W}={\cal S}({\bf Wx-y}){\bf x}^\top
$$
...
已知 $l = -{\bf y^\top}\ln{\cal S}({{\bf W}_2\sigma({\bf W}_1{\bf x})})$ ，求 $\dfrac{\partial l}{\partial {\bf W}_{1}}$ 和 $\dfrac{\partial l}{\partial {\bf W}_2}$ 。
...
\begin{equation}
\begin{aligned}
{\rm d}l &amp;= -{\bf y^\top}{\rm d}\ln{\cal S}({\bf a}_2) \\
...
&amp;= ({\cal S}({\bf a}_2)-{\bf y})^\top{\rm d}{\bf a}_2
\end{aligned}
\end{equation}
$$
...
$$
\frac{\partial l}{\partial {\bf a}_2} = {\cal S}({\bf a}_2)-{\bf y}
$$
...
\frac{\partial l}{\partial {\bf W}_2} &amp;= \frac{\partial l}{\partial {\bf a}_2} {\bf h}_1^\top = ({\cal S}({\bf W}_2{\bf h}_1)-{\bf y})\sigma({\bf W}_1{\bf x})^\top
\end{aligned}
\end{equation}
$$
...
&amp;= (({\bf W}_2^\top({\cal S}({\bf a}_2)-{\bf y}) \odot \sigma^{'}\left( {\bf W}_1{\bf x} \right)){\bf x^\top} \\
\end{aligned}
\end{equation}
$$
...
\begin{equation}
\begin{aligned}
\frac{\partial l}{\partial {\bf W}_1} &amp;=  (({\bf W}_2^\top({\cal S}({\bf W}_2{\bf h}_1)-{\bf y}) \odot \sigma^{'}\left( {\bf W}_1{\bf x} \right)){\bf x^\top} \\
\frac{\partial l}{\partial {\bf W}_2} &amp;=  ({\cal S}({\bf W}_2{\bf h}_1)-{\bf y})\sigma({\bf W}_1{\bf x})^\top
\end{aligned}
\end{equation}
$$